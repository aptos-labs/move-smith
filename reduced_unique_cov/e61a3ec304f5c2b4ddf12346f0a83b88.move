...
module 0xCAFE::AddModule {
    ...
    fun package_visible_double(x: u8): u8 {
        x * 2u8
    }
}
...
// 93ac1c2b72ab45e685131efcc46d2ef4: Test that all built-in logical, comparison, and arithmetic operators evaluate correctly and produce the expected results.
