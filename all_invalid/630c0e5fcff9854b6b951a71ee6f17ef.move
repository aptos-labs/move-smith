...
module 0xCAFE::LambdaPass {
    ...
    public entry fun nested_lambda(
        s: signer,
        f_outer: &dyn Fn(|u64|u64 has copy + drop, u64) -> u64,
    ...
    public fun higher_order_example(): u64 {
        ...
        let outer_lambda: &dyn Fn(|u64|u64 has copy + drop, u64) -> u64 = &(|f, y| {
...
module 0xCAFE::AliasingTest {
    ...
    public entry fun call_lambda_functions(
        ...
        nested_lambda_fn: &dyn Fn(|u64|u64 has copy + drop, u64) -> u64,
        input: u64
    ): u64 {
...
script {
    ...
    fun main(s: signer) {
        ...
        let outer_lambda = &(|f: |u64|u64 has copy + drop, y: u64| { f(y) + 5 });
