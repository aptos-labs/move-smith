...
module 0xCAFE::ModuleC {
    ...
    public fun runner(): bool {
        ...
        let mut_x = 10u64;
        let mut mut_ref = mut_x;
        increment_mut(&mut mut_ref, 15);
        // After increment, mut_ref should be 25
...
// Featurres:
// b43424a993562976d29e28c51e02401a: Test that a function correctly returns a previously assigned variable when called with specific arguments.
