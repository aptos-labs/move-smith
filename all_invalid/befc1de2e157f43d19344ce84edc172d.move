...
//# run 0xCAFE::TestAdvancedFeatures::internal_only_function --signers 0xDEAD --args
// Expect failure: function is internal



//# run 0xCAFE::TestAdvancedFeatures::pure_function --args 5 --signers 0xDEAD
...
module 0xCAFE::LoopShadowTest {
    ...
    public fun shadow_vars_in_while(): u64 {
        ...
        while (counter < 3) {
            let inner_outer_var = outer_var + counter; // Shadowing outer_var
            // Updated inner variable; outer_var remains unchanged
            counter = counter + 1;
        };
...
//# run 0xCAFE::LoopShadowTest::shadow_vars_in_while --signers 0xBADA
// Expect 5
...
//# run 0xCAFE::VisibilityCheck::caller --signers 0xC0FF
// Should succeed



//# run 0xCAFE::VisibilityCheck::internal_function --signers 0xC0FF
// Expect failure: internal function not accessible outside module
