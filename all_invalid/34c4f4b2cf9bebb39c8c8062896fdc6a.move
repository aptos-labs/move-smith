...
module 0xCAFE::LiteralsTest {
    ...
    public fun test_numeric_literals() {
        ...
        let c = 123u64;
        let d = 0xCAFEu16;
        // Binary and octal integer literals are not currently supported in Move,
        // so we have to replace these with decimal/u8 literals:
        let e = 10u8; // 0b1010 is binary for decimal 10
        let f = 63u8; // 0o77 is octal for decimal 63
