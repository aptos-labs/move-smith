...
//# run 0xCAFE::AbilityModifiers::create_storekey --args 0xCAFE 999u64
...
module 0xCAFE::FeatureCheck {
    ...
    public fun create_experiments_list(): Experiments {
        let list = vector[b"move_2", b"big_int", b"address_aliases"];
...
//# run 0xCAFE::FeatureCheck::check_and_declare --args b"move_2" --signers 0xCAFE
...
// Featurres:
// 4b55b18b65fea6e74ddfc184107e876d: Annotate structs with ability modifiers such as copy, drop, store, or key in Move modules
