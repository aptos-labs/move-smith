...
//# run 0xBADD::TestFeature2::create_container --signers 0xCAFÉ --args vector[b"abc", b"def"]

//# run 0xBADD::TestFeature2::add_item --signers 0xCAFÉ --args 100u8

//# run 0xBADD::TestFeature2::get_items --signers 0xCAFÉ
