...
module 0xCAFE::CustomNameError {
    ...
    public fun illegal_resource_return(): R {
...
module 0xCAFE::VerificationErrorModule {
    ...
    public fun store_in_global(_: signer, r: NonKeyResource) {
        move_to<NonKeyResource>(&_, r);
    }
...
module 0xCAFE::FunctionExpressionErrorReporting {
    ...
    public fun f() {
        ...
        // Deliberate type mismatch: passing u16 instead of u8 should give verification error
        let _ = g(10u16);
    }
}
