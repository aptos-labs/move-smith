...
module 0xCAFE::SpecFeatures {
    ...
    spec Sample {
        // Remove 'const' since it's not allowed here
        // Instead, define a named constant as a 'let' or use a pragma for literal assignments
        // Alternatively, omit it if not needed
        // const MAGIC: u64 = 0xDEADBEEF; // <-- Not allowed here

        // Use pragma to assign the magic number as a property instead
        pragma magic = 0xDEADBEEF;
