...
// Featurres:
// 8a4dfa1badf253727ea1c94b2dc90a59: Use the 'inline' keyword to request function inlining.
// d379497b327704ffb3432fc13df9c773: Test that field and tuple struct assignments (including via references and inside enums), chained field assignments, and assignments in while loops and pattern matches work correctly for structs and enums with copy and drop abilities.
