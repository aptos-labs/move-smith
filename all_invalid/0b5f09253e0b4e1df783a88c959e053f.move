...
//# publish
    module 0xCAFE::VersionedFeatures {
        ...
        // For this test, simulate with a compile-time condition
    ...
    public fun test_function_return_type() {
        ...
        if (is_enabled) {
            ...
            if (option::is_some(&opt_fun)) {
                let fun = option::extract(&mut opt_fun);
                let result = fun(10);
...
// 425493fc1dcb505835ed9fd5c41c3ef3: Declare a module as a source or dependency module.
