...
module 0xCAFE::DeprecationTest {
    // Apply anisother deprecation attribute at address level
    //// deprecated]
    use std::signer;
}
...
module 0xCAFE::FunctionAsFirstClass {
    ...
    public fun call_fn_fn<F: 0xCAFE::FunctionAsFirstClass::FnTrait>(f: F, arg: u8): u8 {
        f.call(arg)
    }
...
//# run 0xCAFE::FunctionPurity::test_pure
