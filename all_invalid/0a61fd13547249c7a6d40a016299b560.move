...
module 0xCAFE::SpecFuncTest {
    ...
    spec module {
        // Declaring spec functions of various forms (without 'spec' keyword for declarations)
        ...
        spec fun spec_fun_generic<T>(x: T): bool;
...
module 0xCAFE::ReachabilityTest {
    ...
    spec module {
        ...
        spec fun unreachable_fun(): u64 {
            no;
            // code following no is considered unreachable - unreachable code will be ignored by verifier
            42
        }
