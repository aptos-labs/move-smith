...
module 0xCAFE::FunctionPointerEnums {
    ...
    public fun call_fp_container(s: signer, input: u8): u8 acquires FPContainer {
        ...
        match (&c_ref.fun_ptr) {
            ...
            FPEnum::LambdaCapture {captured: captured, func: func} => func(*captured, input),
        }
    }
...
// f5d6a777d7e3eb1a3296ec651c37df26: Use the 'use' statement with a valid module identifier to include external modules in your code.
