...
module 0xCAFE::MyStructs {
    ...
    public fun runner() {
        ...
        // Will now be 43
        let y = w.inner;
        // Use vector as an implicit dependency (no 'use' needed)
        let mut v = vector::empty<u8>();
        vector::push_back(&mut v, a);
        vector::push_back(&mut v, y);
        // Use cmp as an implicit dependency
...
module 0xCAFE::UseMembers {
    ...
    public fun runner() {
        ...
        let bb2 = get_b(&p);
        // Vector usage as an implicit dependency
...
script {
    ...
    fun main() {
        ...
        // Use implicit dependency on vector
        let v = vector::singleton(a2);

        // Use cmp as implicit dependency (equality test)
