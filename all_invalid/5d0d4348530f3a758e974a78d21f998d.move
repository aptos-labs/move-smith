...
module 0xDEAD::TupleExpressionTest {
    ...
    public fun generate_diagnostic_buffer() {
        let buffer: vector<u8> = vector::empty<u8>();

        // Append a formatted message
        vector::push_back(&mut buffer, s"Diagnostic: error code ".len() as u8);
...
// Featurres:
// 05a8b15aaa17ec2114aa9b363a910193: Create expression lists inside parentheses, separated by commas, to form tuple-like expression lists.
