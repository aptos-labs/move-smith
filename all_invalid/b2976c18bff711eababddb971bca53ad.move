...
module 0xBADD::ErrorDiagnostics {
    ...
    public fun attach_error_diag(_module_name: string::String): bool {
...
module 0xFEED::SourceMap {
    ...
    public fun attach_source_map(_source_map_id: u64): bool {
...
script {
    ...
    fun test_register_formatter() {
        0xDEAD::Debugger::register_formatter(s"TestFormatter");
    }
}
...
script {
    ...
    fun test_attach_error_diag() {
        0xBADD::ErrorDiagnostics::attach_error_diag(s"UnlinkedModule");
    }
}
...
script {
    ...
    fun test_attach_source_map() {
        0xFEED::SourceMap::attach_source_map(42);
    }
}
