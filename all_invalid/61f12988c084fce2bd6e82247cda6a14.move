...
//# run 0xCAFE::TestModule::call_with_closure --signers 0xCAFE --args <not needed, function is generic and invoked directly>
...
module 0xCAFE::TestFeatures {
    ...
    public fun test_closure() {
        let x = 42;
        // Define a closure that takes a reference and prints
