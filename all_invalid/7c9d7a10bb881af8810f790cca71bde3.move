...
module 0xCAFE::TestArithmeticErrors {
    ...
    // A resource with initializer causing overflow
    ...
    public fun create_divide_zero_struct(): S {
        S {
            field1: (1u8 / 0u8), // Parentheses needed for correct parsing
            field2: 0,
        }
    }
    ...
    public fun create_modulo_zero_struct(): S {
        S {
            field1: (1u8 % 0u8), // Parentheses needed
            field2: 0,
        }
    }
    ...
    public fun move_to_in_initializer(): S {
        let m = 42u8;
        S {
            field1: move_from_address(copy m), // Use copy to avoid ownership issues
            field2: 0,
        }
    }
