...
//# run 0xCAFE::SpannedValue::get_location --args 0u64 0u64

//# run 0xCAFE::SpannedValue::get_value --args 0u64 0u64
...
module 0xCAFE::IntegrationTest {
    ...
    public fun create_spanned_loc_struct(a: u8, b: u8, line: u64, col: u64): Spanned::Spanned<LocStruct> {
        let ls = LocStruct { a, b };
        SpannedValue::new_spanned<LocStruct>(ls, line, col)
    }

    public fun create_spanned_loc_struct_with_extra(a: u8, b: u8, val: u8, line: u64, col: u64): Spanned::Spanned<LocStructWithExtra> {
