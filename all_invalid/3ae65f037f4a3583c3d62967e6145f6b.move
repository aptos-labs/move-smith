...
// f21ce4c973b570490ffb06f087c51b8a: Mutate values using index expressions (e.g., array[index] = value) in assignment targets
// 9267209fa349989b0ddc62eacdd42d1a: Verify that struct destructuring with expressions containing references to previously bound variables evaluates fields in left-to-right order and produces the expected values.
