...
module 0xCAFE::FriendTestA {
    ...
    public fun create_secret_value(addr: address, val: u64) {
        let secret = SecretData { value: val };
        move_to<SecretData>(&signer::new(addr), secret);
    }
...
module 0xCAFE::FriendTestB {
    ...
    // This module is friend of FriendTestA and thus can access its SecretData struct fields and functions
...
module 0xCAFE::FriendTestC {
    // Also a friend of FriendTestA, test multiple friends can read/write
...
module 0xCAFE::VectorFriend {
    // friend mod named 'vector', test friend together with vector module name usage
...
// Featurres:
// 93d7a0453839a15306c33649d912c795: Declare 'friend' modules in your module with the 'friend' keyword.
