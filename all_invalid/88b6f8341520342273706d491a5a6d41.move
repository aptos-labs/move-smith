...
module 0xCAFE::ClosureTest {
    ...
    public fun increment_values(vec: &mut vector<KeyValue>) {
        ...
        // Instead we define a standalone function inside the module and use it here.

        // Inline function to increment KeyValue.value by 1
        fun inc(kv_ref: &mut KeyValue) {
            kv_ref.value = kv_ref.value + 1;
        };

        // Implement the loop directly here:
