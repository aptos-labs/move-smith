...
address 0xCAFE {
    module Parser {
        ...
        /// A simple enum to represent a parsed "token" (for demonstration)
        ...
        public fun runner(): vector<u8> {
            ...
            // These represent ASCII codes for digits and commas
...
address 0xBEEF {
    module Logger {
        ...
        // Key is needed for move_to, storing top-level config
