...
script {
    fun main() {
        ...
        // Since Move will catch this, simulate by calling an invalid function or misusing an address
        // But in normal script, this is compile-time error.
        // For test purposes, we can simulate by aborting directly.
        abort 5678;
    }
}
