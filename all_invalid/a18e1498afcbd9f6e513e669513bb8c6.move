...
module 0xCAFE::TestModule {
    ...
    public fun loop_variable_shadowing(init_val: u64): (u64, u64) {
        ...
        let shadow_var = 0u64; // declared immutable, but reassigned via let shadow_var
        {
    ...
    public fun test_multi_borrow_in_function() {
        ...
        let holder_mut = holder;
        // Extract mutable references to fields
        let a_ref = &mut holder_mut.a;
        let b_ref = &mut holder_mut.b;
...
//# run 0xCAFE::TestModule::borrow_conflict_test --signers 0xBADD --args 0xBADD --args 0xBADD
