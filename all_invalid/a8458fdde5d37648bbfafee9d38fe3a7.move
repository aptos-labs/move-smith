...
script {
    ...
    fun main() {
        ...
        // We do not assert, just run. Output is a vector<u8>, convert to string for debug:
        // Move scripts do not have ToString, but we can just ignore output here.
        // The goal is to exercise compiler & VM.
        let _ = output;
    }
}
...
// 4e7f8707ce9151f0fa835966311ee7d5: Generate bytecode for a function based on its AST representation in the environment.
