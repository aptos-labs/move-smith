...
module 0xCAFE::LoopAndArithmeticTest {
    ...
    public fun test_u16_sub(a: u16, b: u16): bool {
        if b > a {
            ...
            // Verify wrapping: result == a as u32 - b as u32 modulo 2^16
    ...
    public fun run_closures_with_patterns() {
...
// e2e4d3bb5c2a5676573dea48ac1d5589: Test that inline function parameters can accept and invoke multiple closures with different argument names and patterns.
