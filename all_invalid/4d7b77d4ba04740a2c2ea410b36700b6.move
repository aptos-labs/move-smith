...
module 0xCAFE::TestFeatures {
    ...
    public fun test_capture_reference_in_lambda() {
        ...
        let lambda: |mutable_ref: &mut u8| u8 = |r: &mut u8| {
            *r = *r + 1;
            *r
        };
        // The above should be invalid if references are not allowed in captures.
        // So, we mark this with expected_failure:
        // // expected_failure]
        // but in this code block, we simulate as if it fails.
    }
