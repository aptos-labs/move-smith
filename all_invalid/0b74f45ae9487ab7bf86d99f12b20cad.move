...
address 0xCAFE {
    module ModuleA {
        ...
        // Note: Remove 'inline' from the type of function parameter f
        public fun map_vec(input: vector<u8>, f: &fun (u8): bool): vector<bool> {
        ...
        public fun map_vec_u8(input: vector<u8>, f: &fun (u8): u8): vector<u8> {
        ...
        public fun runner(): bool {
            ...
            // Define the closure as a named inline function
            inline fun is_even(x: u8): bool {
                x % 2 == 0
            }
            let evens = map_vec(input, &is_even);
