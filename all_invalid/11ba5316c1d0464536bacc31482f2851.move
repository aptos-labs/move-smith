...
module 0xCAFE::UnusedVarsTest {
    ...
    public fun test_unused_vars(x: u8, y: u8): u8 {
        ...
        // Correct syntax: explicit 'as u8' inside parentheses or after expression
        // But in Move, casting uses 'e as u8' which is correct syntax, but needs to be boxed in parentheses
        // The error is caused because 'e as u8' appears as an expression directly assigned to 'd'
        // To fix, wrap the expression in parentheses
        let d = d + (e as u8);
        d
    }
    ...
    public fun create_resource_and_access_fields() {
        ...
        let s = borrow_global_mut<MyResource>(signer_addr);
