...
module 0xCAFE::UpdateSpecTest {
    ...
    spec module {
        update counters: vector<Counter>;
    }
...
// 134b626e91756c7672a57deb1f948b4c: Test that calling the nested functions f2 and f1 within the main function correctly computes and returns the expected value.
