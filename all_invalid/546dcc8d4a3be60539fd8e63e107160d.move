...
module 0xDEAD::TestFeature {
    ...
    public fun run_greatest_product_test() {
        let digits: vector<u8> = vector![1u8, 2u8, 3u8, 4u8, 5u8, 6u8, 7u8, 8u8];
    ...
    public fun run_sort_diagnostics() {
        ...
        let entries: vector<DiagnosticEntry> = vector![
            DiagnosticEntry { primary_location: 300, message: b"Error at 300".copy() },
            DiagnosticEntry { primary_location: 100, message: b"Error at 100".copy() },
            DiagnosticEntry { primary_location: 200, message: b"Error at 200".copy() },
        ];
        // Sort entries
