...
// 2. Provide module identifiers in 'error_location' in attributes for error reporting.
// 3. Assign values to lists of expressions in a single statement (tuple unpack).
...
module 0xCAFE::StructUnpackTest {
    ...
    // Testing error_location attribute for better error reporting.
    // The attribute uses module identifier for visibility in the error output.
    #[error_location(module = "0xCAFE::StructUnpackTest")]
    ...
    public fun runner() {
        ...
        // Intentionally create an error to test error_location attribute.
        // e.g., divide by zero triggers error at this module's location.
    ...
    fun use_vars(x: u8, y: u64, z: bool) {
