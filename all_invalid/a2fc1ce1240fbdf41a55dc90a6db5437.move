...
module 0xDEAD::DebuggerTest {
    ...
    public fun run_tests(
        ...
        if (generic_type == 0) {
            ...
            let gc: GenericContainer<vector<u8>> = GenericContainer { value: vector::empty<u8>() };
            vector::push_back(&mut gc.value, 1);
            vector::push_back(&mut gc.value, 2);
        ...
        fn external_deserialized_func(val: u64): u64 {
            val + 100
        }
