...
//# run 0xDEAD::ComplexFlowInteraction::get_variant_b_a --args NestedEnum::VariantA


//# run 0xDEAD::ComplexFlowInteraction::get_variant_b_a --args NestedEnum::VariantB { a: 42, b: 0 }

 
//# run 0xDEAD::ComplexFlowInteraction::get_variant_c_inner_x --args NestedEnum::VariantC { inner: VariantCInner { x: 7, y: 8 } }
...
// 9e70b9aeaf5adc23d7b98443e9def009: Verify that the Move script correctly assigns a value to the variable within an if-else statement and returns the assigned value.
