...
module 0xCAFE::TestAssignmentAndSpec {
    ...
    spec module {
        ...
        invariant [diagnostic = {
            message = "Invariant failed: x and y must be equal",
            start_line = 37u64,
            start_column = 5u64,
            end_line = 37u64,
            end_column = 41u64
...
module 0xCAFE::DiagnosticSpecMessages {
    ...
    spec module {
        ...
        invariant [diagnostic = {
            message = "This invariant always holds",
            start_line = 21u64,
            start_column = 9u64,
            end_line = 21u64,
            end_column = 48u64
...
// 4154428e845c5e6f1b0726b9b5782a34: Include specification blocks, invariants, and spec functions at the top-level of modules using 'spec', 'invariant', and related constructs.
