...
module 0xCAFE::CombinedTests {
    ...
    public fun run_all_tests(): (u64, bool, u64) {
        ...
        let addr2 = vector[48u8; 32]; // fill with '0' char
        // Replace 10th element with invalid char 'g'
        let i = 0;
...
//# run 0xCAFE::CombinedTests::greatest_product_of_4_digits --args vector[0u8,0u8,7u8,8u8,9u8,1u8,2u8,3u8,4u8]


//# run 0xCAFE::CombinedTests::is_valid_parser_start --args 0 // Number token (0 enum variant)


//# run 0xCAFE::CombinedTests::parse_address --args x"0123456789abcdef0123456789abcdef"


//# run 0xCAFE::CombinedTests::parse_address --args b"shortaddr"


//# run 0xCAFE::CombinedTests::run_all_tests


//# run 0xCAFE::CombinedTests::integrated_test --args vector[1u8,2u8,3u8,4u8,5u8] 0u8 vector[48u8,49u8,50u8]


//# run 0xCAFE::CombinedTests::integrated_test --args vector[9u8,9u8,9u8,9u8,9u8] 4u8 vector[48u8,48u8,48u8,103u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8]


//# run 0xCAFE::CombinedTests::integrated_test --args vector[5u8,6u8,7u8,8u8,9u8] 2u8 vector[48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8,48u8]
