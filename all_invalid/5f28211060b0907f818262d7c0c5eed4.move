...
module 0xBADD::TestModule {
    ...
    public fun filter_module(addr: address): bool {
        ...
        // Use proper Move syntax: convert address to u64 & then check last 4 bits
        // Also, cast the address to u64 for bitwise operations
        let addr_value = address::to_u64(&addr);
        (addr_value & 0xFULL) == 0xA
    }
