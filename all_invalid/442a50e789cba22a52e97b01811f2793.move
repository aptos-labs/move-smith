...
module 0xCAFE::ResourceTest {
    ...
    public fun mutate_value(addr: address, new_val: u64) acquires MyResource {
        let mut res = borrow_global_mut<MyResource>(addr);
...
module 0xCAFE::ResourceTest2 {
    ...
    // This should fail if uncommented: illegal cross-module acquires
    // public fun illegal_acquire(addr: address): u64 acquires ResourceTest::MyResource {
    //     let res = borrow_global<ResourceTest::MyResource>(addr);
    //     res.value
    // }
...
module 0xCAFE::FriendPragma {
    ...
    spec module {
        pragma friend 0xCAFE::ResourceTest;
        pragma friend 0xCAFE::ResourceTest2;
        pragma friend 0xCAFE::FieldMutation;

        // simple spec statement to exercise spec block
        fun dummy_func_spec() ensures dummy_func() == 5;
    }
}
