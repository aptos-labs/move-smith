...
module 0xCAFE::InternalAccess {
    ...
    internal fun create_secret_resource(x: u64): SecretResource {
        SecretResource { secret_data: x }
    }

    // Internal function accessible only within this module
    internal fun get_secret_data(res: &SecretResource): u64 {
        res.secret_data
    }
...
module 0xCAFE::CrossRef {
    ...
    public fun call_internal_create(x: u64): InternalAccess::SecretResource {
