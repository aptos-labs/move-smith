...
//# run 0xDEAD::NestedStructAccess::get_nested_fields --args 0xOriginalOuterRef


//# run 0xDEAD::NestedStructAccess::set_nested_fields --args 0xMutableOuterRef 20u8 400u16 5678u32
...
module 0xFACE::MembersWithExplicitKinds {
    ...
    // Members with deprecated attributes or that are supposed to test invalid member declarations should NOT be included
    // To prevent compile errors, we only declare valid
}


//# run 0xFACE::MembersWithExplicitKinds::get_max_number


//# run 0xFACE::MembersWithExplicitKinds::create_data --args 42u64 true
