...
module 0xCAFE::EvalTest {
    ...
    public fun test_constants(): (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, u8, u64, u128, u256, bool) {
        ...
        let cast_u256 = (u64::MAX as u128 + 1 as u128); // simulate u256 arithmetic by u128
...
// 885b555173c7ee49f42820c28c351a1f: Test that all constant expressions—including comparisons, logic operations, arithmetic (on u8, u64, u128, u256), casts, and byte/vector equality—are correctly evaluated and permitted inside Move const blocks.
