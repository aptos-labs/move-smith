...
module 0xCAFE::ExprEndings {
    ...
    struct Tester has copy, drop { value: u64 }
    ...
    public fun block_expr_in_body(): u64 {
        ...
        let x = {
            let z = 5;
            let sum2 = sum + z; // Side effect, just copy
            z + 6
...
module 0xCAFE::CallExpr {
    ...
    public fun test_calls(): u64 {
        // Terminating with semicolons for multiple let statements
        let a = 0xCAFE::ExprEndings::test_term(0);
        let b = 0xCAFE::ExprEndings::test_term(1);
