...
module 0xCAFE::test_module {
    ...
    public fun run_tests() {
        ...
        // Assuming signer is at 0xBADD
        // move_to operation is omitted for simplicity
        // just for function calling in tests
    }
}
...
script {
    ...
    fun main() {
        // Initialize counter
        // For testing, assume counter already initialized or skip
        ...
        // Assume we have a counter object in storage at this point
        // For the purpose of the test, create a temporary counter variable
