...
// Note: no args needed for function


//# run 0xCAFE::AdvancedFeaturesTest::shadowing_test --signers 0xBADD --args // no args
...
// e9d1dc1a91e29f5a6feabdc7d7689807: Declare local variables with optional 'post' state after a 'let' statement.
