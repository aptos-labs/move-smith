...
module 0xCAFE::FeatureTest {
    ...
    public fun test_decimal_literals() {
        ...
        let _invalid = 12__34u64; // double underscores are invalid - to be caught by compile, but here just a comment
        let _valid3 = 0u64;
    ...
    public fun parse_address_string(address_str: vector<u8>) acquires 0x0 {
