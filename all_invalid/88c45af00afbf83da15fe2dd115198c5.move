...
address 0xCAFE {
    module ModuleA {
        ...
        public fun runner(): bool {
            ...
            let nums = vector::from_elem<u8>(5u8, 3); // [5,5,5]
            let inc_results = map_vec(nums, &inc_fn);
...
script {
    ...
    fun main() {
        // Call the runner function from ModuleA
        let success = ModuleA::runner();
        // ignore assertions as per instruction
        // just exercise the VM with the full flow
    }
}
