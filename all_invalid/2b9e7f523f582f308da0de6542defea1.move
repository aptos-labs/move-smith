...
module 0xCAFE::InlineRefTests {
    ...
    public fun test_immut_refs(): u64 {
        ...
        let get_sum = fun (x: &Container, y: &Container): u64 {
            x.val + y.val
        };
    ...
    public fun test_mut_refs(): u64 {
        ...
        let add_and_swap = fun (x: &mut ContainerMut, y: &mut ContainerMut): u64 {
            let sum = x.val + y.val;
            x.val = y.val;
            y.val = sum;
            sum
    ...
    public fun test_mix_refs(): u64 {
        ...
        let combine = fun (x: &Container, y: &mut ContainerMut): u64 {
            let res = x.val * y.val;
            y.val = y.val + 1;
            res
        };
    ...
    public fun test_create_struct(): ContainerPair {
        ...
        let make_pair = fun (x: &Container, y: &Container): ContainerPair {
    ...
    public fun test_reference_safety(): u64 {
        ...
        let ref_lambda = fun (x: &ContainerMut, y: &mut ContainerMut): u64 {
        ...
        let result = foo_mix(ref_lambda, cref, &mut c);
        // After call, c.val = 43
