...
//# invalid_type
    ...
    public fun invalid_nested_access() {
        // Attempting to access a non-existent nested field
...
//# unresolved_name
        ...
        // Although code won't compile because of the error above
        // Just to satisfy return type
        // But Move requires explicit return without semicolon
        // Let's just add an unreachable dummy
        0u8
    }
