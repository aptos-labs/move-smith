...
module 0xCAFE::DisplayTest {
    ...
    public fun test_name_fragment(id: u64): u64 {
        ...
        let name_fragment = "Item_" ++ u64::to_string(id);
        // In Move, string concatenation is not directly supported,
        // so we simulate by returning the input id for test purposes
        id
    }
