...
module 0xCAFE::BindingTest {
    ...
    alias S = 0xCAFE::MyModule::S;
    alias E = 0xCAFE::MyModule::E;
    ...
    public fun use_alias_to_access_module_members() {
        // Already aliased as S and E
        let e_v2 = E::V2(1, 2);
        ...
        // Instantiate struct with alias
        let s_instance = S {x: 5, y: 10};
        let _ = s_instance;
    }
}
...
//# run 0xCAFE::BindingTest::use_alias_to_access_module_members
