...
module 0xCAFE::test_module {
    ...
    // Fixed: Changed generic parameter to ensure proper ability bounds syntax
    public fun inline_process<F: |u64, bool| { u64 }>(func: F, arg1: u64, arg2: bool): u64 {
        func(arg1, arg2)
    }
    ...
    public fun run_tests() {
        ...
        let result = inline_process<&|u64, bool| { u64 }>(&|x: u64, y: bool| -> u64 {
            if y { x + 1 } else { x - 1 }
        }, 10, false);
        assert!(result == 9);
    }
