...
module 0xCAFE::ScopeAndAccessTest {
    ...
    public fun variable_scope_test() {
        ...
        // shadowed_var = shadowed_var; // No assignment needed here, just a declaration
        ...
        // Calculate expected sum outside loop
        // sum = 100 + (0 + 5) + (1 + 5) + (2 + 5)
        // This equals 100 + 5 + 6 + 7 = 118
        assert!(shadowed_var == 118, 42);
        // Shadowed variable outside loop remains unchanged during loop
        // but since shadowed_var is updated inside loop, check final value
        // It should be 118 as calculated
    }
