...
module 0xBADD::TestModule {
    ...
    public fun run_tests() {
        ...
        let j = 0;
        while (j < 65) {
            vector::push_back(&mut args_vec, j as u64);
            j = j + 1;
        };
...
// Featurres:
// 0f4d7f2716af00941cb708c6a8aa643f: Test that consecutive mutable borrows with computation in let blocks update and access struct fields in the correct order within a single expression.
