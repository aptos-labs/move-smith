...
module 0xCAFE::UseLibrary {
    ...
    public fun runner(s: signer) acquires Container {
        create_container(s, 42u64, vector[b'H', b'I'], 2u8);
...
// 84455e89f4dd035516c16ca776f58811: Include library modules and source definitions within packages.
