...
module 0xBADD::TestInteraction {
    ...
    // Resource protected with internal visibility
    internal fun init_internal_resource(s: &signer, val: u64) {
    ...
    // Internal function to get internal resource value (simulate access restriction)
    internal fun get_internal_value(s: &signer): u64 acquires InternalResource {
    ...
    public fun variable_shadowing(s: &signer) {
        ...
        // Confirm y is modified
        y;
    }

    // Internal functions to test access control
    internal fun should_not_access_external() {
