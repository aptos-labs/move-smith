...
module 0xCAFE::RegularModule {
    ...
    // Function to test tuple_struct_get_first with constructed value
    public fun call_tuple_struct_get_first(): u8 {
        let s = MyTupleStruct { inner: (42u8, false) };
        Self::tuple_struct_get_first(&s)
    }
}
...
/////////////////////////////////////////////
//# run 0xCAFE::RegularModule::call_tuple_struct_get_first --signers 0xCAFE
