...
module 0xCAFE::ClosureAbilityTest {
    ...
    public fun test_closure_invocations() {
        ...
        // (In actual test, would verify values match expected sums)
    }
 ...
 //# run 0xCAFE::ClosureAbilityTest::test_closure_invocations
 //# run 0xCAFE::ClosureAbilityTest::test_closure_multiple

// Featurres:
// d532f17496adc51566fc06bfa0faf740: Specify ability constraints on generic type parameters using a colon (:) followed by plus-separated abilities, such as Copy or Drop, in Move functions, structs, or modules.
