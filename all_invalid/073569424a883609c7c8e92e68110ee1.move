...
module 0xC0DE::CycleTest {
    ...
    // Define nested modules properly within a parent module
    // Move these to be nested inside the main module
//# publish
...
//# publish
    ...
    // Fixed syntax: 'has copy, drop, store' should be after 'struct'
...
//# publish
    module 0xABCD::AddressModule {
        struct AddressHolder has key, store {
            address_val: address,
        }
