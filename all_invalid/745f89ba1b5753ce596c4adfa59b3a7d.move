...
module 0xCAFE::TestExplicitFailures {
    ...
    public fun fail_uninitialized_variable() {
        ...
        if (true) {
            ...
            // missing else branch initialization
        }
        // Next line is intended to cause compile error due to uninitialized x
        // but in the test, this code is commented to avoid runtime failure.
        // assert!(x == 42, 999);
    }
