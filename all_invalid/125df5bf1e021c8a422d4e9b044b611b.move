...
// 7582762232cdfbac1ea7306f1e6f00c7: Test that a loop with an internal conditional both executes and exits correctly, ensuring that a `return` inside the loop terminates the script as expected.
