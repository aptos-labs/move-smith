...
//# run 0xCAFE::SpecTest::test_self_assignment --args 3u8


//# run 0xCAFE::SpecTest::create_st --signers 0xBEEF --args 10u8


//# run 0xCAFE::SpecTest::get_val --signers 0xBEEF


//# run 0xCAFE::SpecTest::set_val --signers 0xBEEF --args 20u8


//# run 0xCAFE::SpecTest::get_val --signers 0xBEEF


//# run 0xCAFE::SpecTest::do_nothing
...
// 5779b6d92f6b7a4804302d847e61777b: Write specification conditions with 'assert', 'assume', 'decreases', 'aborts_if', 'aborts_with', 'succeeds_if', 'modifies', 'emits', 'ensures', and 'requires' inside spec blocks.
