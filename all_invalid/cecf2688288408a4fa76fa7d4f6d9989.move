...
module 0xCAFE::AdvancedGenerics {
    // Remove unused alias to avoid warnings
    // use std::vector;
    ...
    // Annotate test functions correctly with attributes using // test(...)]
...
//# run 0xCAFE::AdvancedGenerics::make_pair --type-args u8,bool --args 10u8 true
