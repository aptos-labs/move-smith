...
module 0xCAFEBABE::TupleAndMatchTest {
    ...
    public fun test_tuple_assignment(counter: &mut GlobalCounter): (u8, u8) {
        ...
        // tuple assignment: evaluate right to left, Move evaluates left to right
    ...
    public fun run_tests() {
        ...
        // (Assuming the necessary resource setup is done elsewhere or omitted here for brevity)
        // For example, creating an instance:
        // let counter = &mut GlobalCounter { count: 0 };
        ...
        // You can perform assertions or log results here
