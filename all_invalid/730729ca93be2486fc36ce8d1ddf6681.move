...
module 0xCAFE::LValueDestructuringTest {
    ...
    public fun destructure_lvalues() {
        ...
        // Replace vector::sub_range with vector::sub_range_immut if available, else use vector::slice
        // Aptos stdlib vector does not have sub_range; use vector::slice instead:
        let middle = vector::slice(&v, 1, len - 2);
