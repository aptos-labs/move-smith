...
//# run 0xCAFE::FilterAndAnnotate::filter_items --args 'address:0xCAFE,vector:[struct:0xCAFE::FilterAndAnnotate::Item{id:1u8,flag:true},struct:0xCAFE::FilterAndAnnotate::Item{id:2u8,flag:false},struct:0xCAFE::FilterAndAnnotate::Item{id:3u8,flag:true}]' bool:true
