...
public fun test_matching_patterns() {
    ...
    let result3 = 0xDEAD::EnumPatternMatching::match_enum(MyEnum::TwoFields(3, 4));
    let inner_struct = InnerStruct { a: 5, b: 6 };
    let outer_struct = OuterStruct { x: 123, y: option::Some(inner_struct) };
