...
module 0xCAFE::FunctionTypes {
    ...
    // Removed #[copy] attribute, instead add copy ability to enum:
    // This requires us to explicitly implement `copy` ability on enum.
    ...
    public enum FuncWrapper has copy {
        Zerary(fn(): u64),
        Unary(fn(u64): u64),
...
//# publish
module 0xCAFE::FunctionGeneric<phantom T, phantom U> {
