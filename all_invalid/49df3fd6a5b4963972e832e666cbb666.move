...
//# run 0xCAFE::EnumPatternMatching::test_match --args MyEnum::VariantTuple(10, 20)

//# run 0xCAFE::EnumPatternMatching::test_match --args MyEnum::VariantStruct { a: true, b: 5 }

//# run 0xCAFE::EnumPatternMatching::test_match --args MyEnum::VariantStruct { a: false, b: 7 }

//# run 0xCAFE::EnumPatternMatching::test_match --args MyEnum::VariantNested(Box::new(MyEnum::VariantEmpty))

//# run 0xCAFE::EnumPatternMatching::test_match --args MyEnum::VariantEmpty


//# run 0xCAFE::EnumPatternMatching::test_bindings --args MyEnum::VariantTuple(42, 100)

//# run 0xCAFE::EnumPatternMatching::test_bindings --args MyEnum::VariantStruct { a: false, b: 55 }

//# run 0xCAFE::EnumPatternMatching::test_bindings --args MyEnum::VariantNested(Box::new(MyEnum::VariantEmpty))

//# run 0xCAFE::EnumPatternMatching::test_bindings --args MyEnum::VariantEmpty

// Test module marked for deprecation (simulate - no runtime effect, but included as part of the test)

//# run 0xCAFE::DeprecatedModule::dummy
...
// 2fd553d30fe7941f26c19b21d89c1105: Check if a module has been marked as deprecated within the compiler context.
