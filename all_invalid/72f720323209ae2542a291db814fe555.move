...
module 0xCAFE::VerificationTest {
    ...
    public fun match_rest_pattern(): u64 {
        ...
        match (all) {
            v if vector::length(&v) == 3 => {
                // Match the first, rest, and last explicitly
    ...
    public fun annotated_inline(x: u32): u32 {
...
//# run 0xCAFE::VerificationTest::match_with_rest --args vec![10u8, 20u8, 30u8]

// Note: The argument should be passed as a vector literal, e.g. vec![10u8, 20u8, 30u8]
