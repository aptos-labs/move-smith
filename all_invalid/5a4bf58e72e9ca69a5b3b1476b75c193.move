...
// Corrected the argument: wrap the enum variant in quotes, and properly escape/parsing.
// Need to pass the entire enum as a string argument, so wrap the enum variant in quotes.
