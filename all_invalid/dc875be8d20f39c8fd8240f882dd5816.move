...
module 0xCAFE::BigInt256 {
    ...
    public fun add(a: Uint256, b: Uint256): Uint256 {
        let (low, carry) = std::math::u128_add_with_overflow(a.low, b.low);
        let high = a.high + b.high + (carry as u128);
        Uint256 { high, low }
    }

    public fun sub(a: Uint256, b: Uint256): Uint256 {
        let (low, borrow) = std::math::u128_sub_with_borrow(a.low, b.low);
    ...
    public fun div(a: Uint256, b: Uint256): Uint256 acquires Uint256 {
    ...
    public fun mod(a: Uint256, b: Uint256): Uint256 acquires Uint256 {
    ...
    friend module 0xCAFE::FriendModule;
}
...
// Featurres:
// d6e45cad7d0de46b40d3eb87a82a5be8: Designate friend modules or functions to allow privileged access.
// 0930f39e34bf3654b01812ec2c4024b5: Use variables directly in expressions, including by name, move, or copy.
// f81800fdd9bc3e37b73e71331b767723: Verify that 256-bit unsigned integer arithmetic operations—including addition, subtraction, multiplication, division, and modulus—handle typical cases correctly, prevent overflow or underflow, and properly fail or revert on invalid operations such as division or modulus by zero.
