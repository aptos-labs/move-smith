...
module 0xDEAD::SpecTest {
    ...
    public fun package_info_test() {
        ...
        let module_name = x"SpecTest"; // Fixed: use x"..." for byte string
        let modules_vector = vector::empty<&str>();
        vector::push_back(&mut modules_vector, *string::utf8(module_name));
    ...
    public fun abilities_and_metadata() {
        ...
        vector::push_back(&mut modules, *string::utf8(x"SpecTest")); // Fixed: use x"..." and dereference
        let package_meta = (
            pkg_name,
            ver_major,
            ver_minor,
