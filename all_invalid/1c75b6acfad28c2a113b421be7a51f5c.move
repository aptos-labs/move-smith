...
module 0xCAFE::AbilitySpecTest {
    ...
    public fun generic_copy_func<T has copy>(value: T): T {
...
// Featurres:
// 942f08ea913776c234245a3c4abdb201: Use the 'has' keyword to specify ability constraints for a type in a function signature.
