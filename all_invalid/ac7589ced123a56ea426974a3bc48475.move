...
module 0xCAFE::BitwiseAndLoopTest {
    ...
    public fun test_bitwise_ops(): (u8, u8, u8, u16, u16, u16, u32, u32, u32, u64, u64, u64, u128, u128, u128, u256::T, u256::T, u256::T) {
        ...
        let val1_u256: u256::T = u256::from_hex(x"5555555555555555555555555555555555555555555555555555555555555555");
        let val2_u256: u256::T = u256::from_hex(x"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
