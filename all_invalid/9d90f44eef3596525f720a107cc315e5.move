...
module 0xCAFE::MathUtils {
    ...
    public fun show_variable_states(): u64 {
        ...
        debug::print(&b"x before=10, y before=3, s after add=13, d after sub=7, m after mul=30");
        s + d + m
    }
...
script {
    ...
    fun main(account: &signer) {
        ...
        debug::print(&b"Vec length in script");
...
module 0xCAFE::VarTrace {
    ...
    public fun variable_logging_example(): u64 {
        let a = 12;
        debug::print(&b"a initialized=12");
        let b = 8;
        debug::print(&b"b initialized=8");
        let c = a * b;
        debug::print(&b"c=a*b=96");
        let d = c + 1;
        debug::print(&b"d=c+1=97");
        d
    }
