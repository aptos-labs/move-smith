...
module 0xCAFE::LoopAndOperators {
    ...
    public fun runner(): bool {
        ...
        let end: u64 = 10;
        let i: u64;
        // Move does not allow `mut` keyword and does not have "for i in start..=end"
        // but it supports ranges in for loops directly
        for i in 0..=10 {
            sum = sum + i;
        };
        ...
        let mut sum_half_open: u64 = 0;
        for i in 0..5 {
            sum_half_open = sum_half_open + i;
        };
        // sum 0..5 = 10 (0+1+2+3+4)

        let mut sum_closed: u64 = 0;
        for i in 0..=5 {
