...
module 0xCAFE::NamedGeneric {
    ...
    public fun publish_container<T>(account: &signer, value: T) acquires Container {
...
//# run 0xCAFE::NamedGeneric::borrow_val<u64> --args  // Will fail without an object, shown here for completeness
