...
module 0xCAFE::AbilityConstraintTest {
    ...
    */
    ...
    public fun combined_feature_test<T: copy + drop + store>(_: T) {
...
//# run 0xCAFE::AbilityConstraintTest::combined_feature_test --type-args 0xCAFE::AbilityConstraintTest::CopyDropStore
