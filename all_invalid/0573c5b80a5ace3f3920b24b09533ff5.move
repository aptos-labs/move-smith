...
module 0xCAFE::TestModule {
    ...
    struct MyEnum has copy, drop {
        VariantA { x: u64, y: bool },
        VariantB(u8, u16),
        VariantC { a: bool, b: u8, c: u64 },
    }
...
//# run 0xCAFE::TestModule::complex_return --signers 0xBADD --args

//# run 0xCAFE::TestModule::operation_tests --signers 0xBADD

// Featurres:
// 16861130459b06e858537bafdb659770: Test that multiple code blocks used as expressions in a single return statement can independently mutate and use local variables.
