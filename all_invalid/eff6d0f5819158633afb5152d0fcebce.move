...
module 0xCAFE::ComprehensiveTest {
    ...
    public fun init(): bool {
        ...
        while (i < len_vals) {
            ...
            let old = vector::swap(&mut VALUES, i, updated_val);
            i = i + 1;
        };
        // Assert correctness
...
// 8d139cfbccdea281e24a4fd327ddea56: Terminate 'axiom' conditions with a semicolon in the specification block syntax.
