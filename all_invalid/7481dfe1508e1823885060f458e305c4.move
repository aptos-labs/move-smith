...
module 0xC0FF::FeatureInteractionTest {
    ...
    public fun run_tests(s: signer) {
        ...
        // Verify that outer shadow_var remains unchanged
        ...
        // Assume some internal function that uses structure
...
//# run 0xC0FF::FeatureInteractionTest::run_tests --signers 0xABC0 --args 0u8
...
// 37bb9e98c93c8f1e68c66721ce36f918: Use 'parse_identifier' to recognize and parse identifier tokens from source code.
