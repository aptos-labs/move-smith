...
module 0xCAFE::AdvancedTest {
    ...
    */
    ...
    public fun read_res_value(s: &signer) acquires Res: u8 {
    ...
    public fun combined_test(s: signer): u8 acquires Res, Foo {
        let x = 0u8;
        {
...
// Featurres:
// 6466fb3a5b2d834c0efbf8d66c0b90fa: Test that mutable references to resources acquired with acquires cannot be captured or accessed inside local lambda closures.
// d25cbdea61a024eda73a3c339873639b: Test that mutable variable updates within nested blocks correctly affect the overall expression's result in a Move function.
