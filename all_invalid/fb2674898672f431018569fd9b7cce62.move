...
module 0xCAFE::AdvancedFeaturesTest {
    ...
    public fun test_variable_assignments() {
        ...
        while (i < 3) {
            ...
            assert!((inner_var == i * 10), 0);
            // after inner scope, outer inner_var remains unchanged
            i = i + 1;
        };
