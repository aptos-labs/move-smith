...
module 0xCAFE::TestModule {
    ...
    public fun verify_compliance() {
        ...
        let PositionalStruct((a, b, c)) = &moved_copy_struct; // Error: mismatch? 
        // Correction: unpack tuple
        let PositionalStruct(t) = &moved_copy_struct; // incorrect, as not matching
        // Correct: unpack the positional struct's inner tuple
        // Since PositionalStruct contains a tuple
