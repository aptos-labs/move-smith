...
//# run 0xCAFE::PackagePathConversion::convert --args vector[]:vector<address> vector[(b"alice", @0x1), (b"bob", @0x2)]:vector<(string::String, address)> vector[b"Token",b"Coin"]:vector<string::String>
