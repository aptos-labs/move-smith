...
module 0xCAFE::AdvancedPatterns {
    ...
    public fun assign_variant_value(): Container {
        ...
        // Rewrite pattern matching without macro `matches!` (not supported in Move)
    ...
    // Helper function to check if AssignEnum is Assigned variant
    public fun exists_assigned(assign_value: AssignEnum): bool {
        // pattern match using 'match' expression
        match assign_value {
    ...
    public fun destructure_with_range_pattern(): u8 {
        ...
        // Using vector::borrow to access elements:
