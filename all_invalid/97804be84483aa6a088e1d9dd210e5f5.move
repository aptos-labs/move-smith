...
module 0x1::UnitTest {
    ...
    // A function marked for external visibility with custom attribute
    public fun // externally_visible] process_data(id: u64, data: vector<u8>): bool {
    ...
    // Function to test organization of members and reuse
