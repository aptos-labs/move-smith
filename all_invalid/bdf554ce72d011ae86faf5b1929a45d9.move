...
module 0xCAFE::AnyAddressMutationControlFlow {
    ...
    public fun create_data_at_any(addr: address, val: u64) {
        let data = Data { val };
        move_to<Data>(&signer::borrow_address(addr), data);
    }
    ...
    public fun create_complex_data(addr: address, init: u64) {
        ...
        move_to<ComplexData>(&signer::borrow_address(addr), cd);
    }
...
// Featurres:
// 0526b0fd53dbdc8c84bfead3cb6abb12: Use address specifier 'Any' to allow any address in your code.
// a2552f8a4591846f6b8cb83e6ae18c20: Mutate variables, references, or struct fields with assignment or compound assignment.
// 5158f02792f911469a17d2f0eeb77dff: Write code that detects the presence of control flow redirections such as loops, returns, or abort calls within expressions.
