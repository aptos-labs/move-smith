...
//# run 0xCAFE::TestLoopAndStructs::GenericStruct::<u64>::GenericStruct --signers 0xCAFE --type-args u64 --args 99u8 10u8
//# run 0xCAFE::TestLoopAndStructs::GenericStruct::<vector<u8>>::GenericStruct --signers 0xCAFE --type-args vector<u8> --args b"data" 5u8