...
//# run 0xCAFE::ExpressionTest::common_access --args 0xCAFE::ExpressionTest::Foo::A(123u64, 456u64)


//# run 0xCAFE::ExpressionTest::common_access --args 0xCAFE::ExpressionTest::Foo::B(789u64)
...
// ecc192150fc4f74ea3be2e170cb1ed42: Test that the `common_access` function correctly accesses the first field of the `Foo` enum variant.
