...
module 0xCAFE::Vector {
    ...
    public fun len<T>(_v: vector<T>): u64 {
...
module 0xCAFE::ShadowTest {
    // Uses 0xCAFE::Vector::len() which should resolve correctly.

    public fun test_shadow(): u64 {
        // Use fully qualified path as no 'use' declaration
        0xCAFE::Vector::len(vector[7u8, 8u8])
    }
