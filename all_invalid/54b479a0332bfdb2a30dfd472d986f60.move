...
//# run 0xCAFE::PatternTest::enum_pattern_match_example --args 0xCAFE::PatternTest::ResultType::Ok(555u64)


//# run 0xCAFE::PatternTest::enum_pattern_match_example --args 0xCAFE::PatternTest::ResultType::Err { code: 999u64, message: b"fail" }
