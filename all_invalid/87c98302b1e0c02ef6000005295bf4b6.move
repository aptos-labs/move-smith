...
//# run 0xDEADBEEF::AccountStructures::get_balance --args 0xDEADBEEF::AccountStructures::create_profile(0xDEADBEEF, b"User1", 1000u64)


//# run 0xDEADBEEF::AccountStructures::update_balance --args 0xDEADBEEF::AccountStructures::create_profile(0xDEADBEEF, b"User1", 1000u64) 1500u64


//# run 0xDEADBEEF::AccountStructures::deactivate_profile --args 0xDEADBEEF::AccountStructures::create_profile(0xDEADBEEF, b"User1", 1000u64)


//# run 0xDEADBEEF::AccountStructures::check_active --args 0xDEADBEEF::AccountStructures::create_profile(0xDEADBEEF, b"User1", 1000u64)
...
// f994ca2e76b5a47cc249fb2cebf07b4b: Dynamically manipulate fields of structures with dotted expressions.
