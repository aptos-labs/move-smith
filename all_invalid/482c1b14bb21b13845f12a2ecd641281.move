...
module 0xCAFE::CrossModuleVisibility {
    ...
    // Public(friend): only accessible from friend modules (none declared here for simplicity)
...
module 0xCAFE::CallerModule {
    ...
    // Calls friend function - should fail without friend relationship, but here for test
...
module 0xDEAD::DefaultAddressModule {
    ...
    public fun cross_call_caller_module(): u8 {
        0xCAFE::CallerModule::call_public()
    }
}
