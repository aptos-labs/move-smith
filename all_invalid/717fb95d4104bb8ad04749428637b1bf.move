...
module 0xCAFE::AssignmentAndPattern {
    ...
    public fun destructuring_example(p: Pair): u8 {
        ...
        let sum = 0u8;
        // For loop with destructuring of tuple
        for ((x, y) in v) {
            sum = sum + x + y;
        };
...
//# run 0xCAFE::AssignmentAndPattern::assign_example --args 7 3



//# run 0xCAFE::AssignmentAndPattern::destructuring_example --args 5 8
