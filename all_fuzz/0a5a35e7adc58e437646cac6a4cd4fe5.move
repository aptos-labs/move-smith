...
//# run 0xCAFE::MathModule::add_and_transform --args 20u8 22u8



//# run 0xCAFE::MathModule::lambda_example --args 7u8



//# run 0xCAFE::MathModule::call_inline_adder --args 8u8 12u8



//# run 0xCAFE::MathModule::assign_unit



//# run 0xCAFE::MathModule::store_lambdas



//# run 0xCAFE::MathModule::invoke_lambdas --args 5u8



//# run 0xCAFE::ExistsAndCall::call_add_and_transform_with_exists



//# run 0xCAFE::ExistsAndCall::call_lambda_example --args 11u8



//# run 0xCAFE::ExistsAndCall::call_inline_adder --args 13u8 7u8



//# run 0xCAFE::ExistsAndCall::demo_unit_assign



//# run 0xCAFE::ExistsAndCall::demo_lambda_vector_call --args 4u8
