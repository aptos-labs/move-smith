...
module 0xCAFE::ShadowCapture {
    ...
    public fun foo() {
        let x = 1u8;
        // Move currently does not support function types or lambdas like |()| u8 directly.
        // Instead, we just inline the logic here.
        let x = x + 1;
        let x = x + 1;
        let result = x;
        ...
        let x = result;
        // x now updated to 3 by shadowing and capture within the lambda (simulated)
    }
