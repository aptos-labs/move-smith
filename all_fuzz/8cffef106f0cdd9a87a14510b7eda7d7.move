...
module 0xCAFE::AdditionModule {
    // This module tests addition of two u8 values and return a specific value.
...
//# run 0xCAFE::AdditionModule::add_and_return_constant --args 5u8 6u8
...
module 0xCAFE::CallerModule {
    ...
    public fun call_inline_and_lambda(a: u8, b: u8): u8 {
        ...
        let final_value = AdditionModule::add_and_return_constant(sum, 0u8);
        let lambda_result = AdditionModule::run_lambda_example();
        final_value + lambda_result
    }
}


//# run 0xCAFE::CallerModule::call_inline_and_lambda --args 7u8 8u8
