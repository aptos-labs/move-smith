...
module 0xCAFE::BytecodeNative {
    ...
    public fun update_byte(s: signer, idx: u64, byte: u8) {
        ...
        // Since Move vector index is usize, convert idx to usize by cast
        let i = idx as usize;
        *vector::borrow_mut(&mut r_mut.data, i) = byte;
    }
...
//# run 0xCAFE::BytecodeNative::publish_resource --signers 0xBADD --args x"444154415f4259544553" 1u64 b"stacklessbytecodebytes"
...
module 0xCAFE::ListErrorHandling {
    ...
    public fun parse_u8_list(bytes: vector<u8>): u64 {
        ...
        while (i < vector::length(&bytes)) {
            let b = *vector::borrow(&bytes, i as usize);
...
//# run 0xCAFE::ListErrorHandling::parse_u8_list --args vector[1u8,2,3,4] 


//# run 0xCAFE::ListErrorHandling::parse_u8_list --args vector[1u8, 0xFFu8, 2u8]
...
//# run 0xCAFE::ListErrorHandling::safe_parse --args vector[1u8,2u8,3u8]


//# run 0xCAFE::ListErrorHandling::safe_parse --args vector[1u8, 0xFFu8, 3u8]
