...
#[derive(Clone)]
pub struct SecondBlockGenerator;

impl Generator for SecondBlockGenerator {
...
fn register_generator() -> (GenLabel, GeneratorT, Option<GenLabel>) {
    (
        GenLabel::new("SecondBlockGenerator"),
        Box::new(SecondBlockGenerator),
        Some(GenLabel::new("BlockGenerator")),
    )
}
